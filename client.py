...
def main():
    ...
    try:
        ...
        while True:
            print('Выберите режим работы клиента:\n'
                  'send (Режим работы - отправка сообщений)\n'
                  'listen (Режим работы - приём сообщений)')
            client_mode = input('->')
            if client_mode == 'send' or client_mode == 'listen':
                break
            else:
                print("Неправильно указан режим работы!")
